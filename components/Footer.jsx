...
const Footer = () => (
  ...
  >
    ...
    <div className='flex flex-col '>
      <div  className='mt-[25px] h-[2px] bg-white opacity-10 '/>

      <div className= ' mt-[50px] flex items-center justify-between flex-wrap gap-4 '>
        <h4 className='font-extrabold text-[24px] text-white'>MetaVersus</h4>
        <p className='font-normal text-[14px] text-white opacity-50'>Copyright © 2022 - 2023 Shoaib Metaversus. All rights reserved.</p>
